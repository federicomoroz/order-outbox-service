package com.federicomoroz.orderoutbox.order.architecture;
...
/**
 * Five executable rules that make the hexagonal boundaries real instead of aspirational. A
 * failure here is an architecture bug to fix — never a rule to weaken.
 */
class HexagonalArchitectureTest {

    private static final String BASE_PACKAGE = "com.federicomoroz.orderoutbox.order";
